...
public class BaseClass {
	...
	//Method 8.9 Robot_Goto_Top_Of_Webpage
	public static void gotoTopOFWebpage() throws AWTException {
		Robot r = new Robot();
		r.keyPress(KeyEvent.VK_CONTROL);
	...
	//Method 8.10 Robot_Goto_Bottom_Of_Webpage
	public static void gotoBottomOfWebpage() throws AWTException {
		Robot r = new Robot();
		r.keyPress(KeyEvent.VK_CONTROL);
	...
	public static String getData(int rowNumber, int cellNumber) throws IOException {
		...
		File f = new File("F:\\SIVA testing course\\eclipse-workspace\\CucumberDay1PracticeVersion1.1\\target\\TestData\\FacebookLoginDetails.xlsx");
		...
		if(cellType == 1) {    //String data
			value = c.getStringCellValue();
		}else if(cellType == 0) {//Number value (or) Date value
			if(DateUtil.isCellDateFormatted(c)) {  //Date value
	...
	//Method 21.0 Navigate to the next web page with reference to the browser's history
	public static void navigateForward() {
		driver.navigate().forward();
	}
	//Method 21.1 Navigate to the previous web page with reference to the browser's history
